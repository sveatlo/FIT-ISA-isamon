...
\section{Network scanning}
	...
	\subsection{ARP scanning}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.7\linewidth]{images/arp.jpg}
	...
	\subsection{IMCP echo scanning}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.7\linewidth]{images/icmp.png}
			%\caption{ARP packet format}
...
\section{Port scanning}
	...
	\subsection{TCP port scanning}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.7\linewidth]{images/tcp_header.png}
			%\caption{ARP packet format}
			\caption{TCP header}
